...
class TestRegistration:
    ...
    def test_register_default_region(self, browser):
        """ Проверка региона регистрации по умолчанию. """
        go_to_reg(browser)
        page = RegisterPage(browser, browser.current_url)
        page.should_be_default_region("Москва")

    def test_register_select_some_region(self, browser):
    ...
    def test_register_complete(self, browser, address):
    ...
    def test_register_empty_fields(self, browser):
    ...
    def test_register_first_name_length_good(self, browser, type_name: str, length_name: int):
    ...
    def test_register_first_name_length_bad(self, browser, type_name: str, length_name: int):
    ...
    def test_register_phone_length_good(self, browser, phone: tuple):
    ...
    @pytest.mark.parametrize("phone", [('+7', 9), ('+7', 11), ('+375', 8), ('+375', 10),
                                       ('+6', 10), ('+475', 9), ('', 0)],
                             ids='prefix {0[0]} and {0[1]} digits'.format)
    def test_register_phone_length_bad(self, browser, phone: tuple):
    ...
    def test_register_email_length_good(self, browser, user: int, server: int):
    ...
    def test_register_email_length_bad(self, browser, user: int, server: int):
    ...
    def test_register_passwords_length_good(self, browser, password: str, length_password: int):
    ...
    def test_register_passwords_length_bad(self, browser, password: str, length_password: int):
    ...
    @pytest.mark.negative
    def test_register_passwords_not_equal_bad(self, browser):
    ...
    def test_register_email_equivalence_good(self, browser, mail_name: tuple):
    ...
    def test_register_email_equivalence_bad(self, browser, email):
    ...
    def test_register_passwords_good(self, browser, password: str, text_password: str):
    ...
    def test_register_passwords_bad(self, browser, password: str, text_password: str):
    ...
    def test_register_passwords_popular(self, browser, text_password: str):
        """ Негативные тест-кейсы. Проверка ПАРОЛЯ и ПАРОЛЯ ПОДТВЕРЖДЕНИЯ по классам эквивалентности """
        go_to_reg(browser)
        page = RegisterPage(browser, browser.current_url)
    ...
    @pytest.mark.positive
    def test_successful_registration_from_a_virtual_email(self, browser):
