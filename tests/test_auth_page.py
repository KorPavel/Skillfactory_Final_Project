...
class TestAuth:
    ...
    def test_guest_should_see_various_forms_of_registration(self, browser, account):
    ...
    def test_guest_should_see_support_phone(self, browser):
    ...
    def test_auth_ok_by_tab(self, browser, tab):
        """ Базовая проверка авторизации "ТЕЛЕФОН + ПАРОЛЬ", "ПОЧТА + ПАРОЛЬ", "ЛОГИН + ПАРОЛЬ" """
        page = AuthPage(browser)
        page.open()
        page.insert_user_data_to_fields(valid_user_data[tab], valid_user_data['password'])
    ...
    def test_auth_any_tabs_bad(self, browser, tab):
    ...
    @pytest.mark.parametrize('tab', ['phone', 'email', 'login', 'ls'], ids='{}'.format)
    def test_check_autochange_tabs(self, browser, tab):
    ...
    def test_check_valid_phone_good(self, browser, count_digits):
    ...
    def test_check_valid_phone_bad(self, browser, count_digits):
    ...
    def test_check_valid_email_good(self, browser, mail_name, mail_domain):
    ...
    def test_check_valid_email_bad(self, browser, mail_name, mail_domain):
    ...
    def test_check_valid_ls_good(self, browser, count_digits):
    ...
    def test_check_valid_ls_bad(self, browser, count_digits):
    ...
    def test_check_length_login_value_good(self, browser, placeholder, length_value):
    ...
    @pytest.mark.parametrize('placeholder', [get_nums, letters_en, letters_ru, letters_cn, get_specsymbols],
                             ids='{0.__name__}'.format)
    def test_check_length_login_value_bad(self, browser, placeholder, length_value):
